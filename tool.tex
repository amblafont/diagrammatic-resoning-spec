...
% END OF GENERATED LATEX
\] 
It does not fit the format\footnote{There is a logic called the calculus of conditions where this can be made formal (see "Conditional reactive systems").} $∀ .. ∃ .. P$ of our previous rewriting rules (see \Cref{rem:formula-fo}).
