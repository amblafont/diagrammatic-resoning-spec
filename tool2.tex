...
We may consider a color scheme to visualise the different layers on the same drawing. The reason I do not emphasize too much is because it forbids using colors when drawing elements.
